...
return new class extends Migration
{
    ...
    {
        Schema::table('tes_users', function (Blueprint $table) {
            $table->dropForeign(['id_guru']); // Hapus foreign key id_kelas
            $table->dropForeign(['id_ortu']); // Hapus foreign key id_kelas
            ...
            $table->dropColumn('id_ortu'); // Hapus kolom id_kelas jika diperlukan
        });
    }
