...
@section('title', 'Halaman Guru | Detail Murid')
@section('content_header')
<h1 class="m-0 text-dark"> Detail Murid |
    <span style="font-weight:bold; color: #ff9e2a;">Daftar Kelas</span></h1>
@stop

@section('content')
{{-- Halaman Ini di atur pada RincianController/method index --}}
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.length === 0) {
                    ...
                    var url = '{{ route("modul.guru.detail", ["id_kelas" => ":id_kelas", "id_ta" => ":id_ta", "id_guru" => ":id_guru"]) }}';
                    url = url.replace(':id_kelas', kelas.id_kelas).replace(':id_ta', kelas.id_ta).replace(':id_guru', id_guru);
