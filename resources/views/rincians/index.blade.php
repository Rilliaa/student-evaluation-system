...
@section('title', 'Rincian Nilai || Daftar Kelas')

@section('content_header')
<h1 class="m-0 text-dark"> 
    Halaman Kelola Nilai | 
    <span style="color: #ff9e2a; font-weight:bold">Daftar Kelas</span>
</h1>
@stop
                ...
                <form id="formFilterTahunAjaran">
                    <div class="form-group">
                        ...
                        <select id="tahunAjaran" name="tahunAjaran" class="form-control" required>
                            <option value="" selected disabled> -- Pilih Kode Tahun Ajaran--</option>
                ...
                if (response.length === 0) {
                    ...
                    response.forEach(function(kelas, index) {
                        var row = '<tr>' +
                                    ...
                                    '<td>' + kelas.kode_ta + '</td>' +
                                    '<td>' +
                                        '<a href="{{ url('/kelas') }}/' + kelas.id_kelas + '/' + kelas.id_ta + '" class="btn btn-primary btn-sm">' +
