        ...
        <div class="card-body">
            <form>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="no_hp" value="{{ $user->no_hp ? $user->no_hp : '-' }}" readonly>
                </div>
                <div class="form-group">
        ...
        <div class="modal-dialog modal-dialog-center">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="changePasswordModalLabel">Edit Akun</h5>
                ...
                <div class="modal-body">
                    <form id="changePasswordForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="no_hp" name="no_hp" value="0{{ $user->no_hp }}" required>
                        </div>
                        <div class="form-group">
